== rades.forge-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The rades.forge-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>com.github.funthomas424242.rades</groupId>
   <artifactId>rades.forge-addon</artifactId>
