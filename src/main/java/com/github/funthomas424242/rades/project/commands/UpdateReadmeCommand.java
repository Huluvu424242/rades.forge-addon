...
public class UpdateReadmeCommand extends AbstractProjectUICommand {
    ...
    public Result execute(UIExecutionContext context) throws Exception {
        ...
        final RadesProject readesProject = new ObjectMapper().readValue(jsonTxt, RadesProject.class);
        final RadesProjectAccessor radesProjectAccessor = new RadesProjectAccessor(readesProject);
        ...
        if (!readmeFileResource.exists() || readmeFileResource.getContents(StandardCharsets.UTF_8).isEmpty()) {
            ...
            copyContentTo(readmeFileResource, radesProjectAccessor);
        } else {
...
//            final ContentPart part0 = adocDocument.getPartById("status");
    ...
    public void copyContentTo(FileResource readmeFileResource, final RadesProjectAccessor radesProject) {
